# Install script for directory: /home/zjd/3dpart/openmvs1.1.1/apps/RefineMesh
...
file(INSTALL DESTINATION "/usr/local/bin/OpenMVS" TYPE EXECUTABLE FILES "/home/zjd/3dpart/openmvs1.1.1/openmvs_build/bin/RefineMesh")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/OpenMVS/RefineMesh" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/OpenMVS/RefineMesh")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/OpenMVS/RefineMesh"
