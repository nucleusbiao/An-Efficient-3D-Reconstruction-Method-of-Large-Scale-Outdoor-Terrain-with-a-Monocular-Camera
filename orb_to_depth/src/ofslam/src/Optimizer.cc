/**
* This program is used for optimizing camera pose
*/
/*
The first optimization function：GlobalBundleAdjustemnt
The second optimization function：BundleAdjustment
The third optimization function：PoseOptimization
Fourth optimization function：LocalBundleAdjustment
The fifth optimization function第五个优化函数：OptimizeEssentialGraph
Sixth optimization function：OptimizeSim3
*/
#include "Optimizer.h"
