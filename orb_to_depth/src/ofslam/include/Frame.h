...
public:
    ...
    // mvKeys:原始左图像提取出的特征点（未校正＄1�7
    // mvKeysRight:原始右图像提取出的特征点（未校正＄1�7
    // mvKeysUn:校正mvKeys后的特征点，对于双目摄像头，丢�般得到的图像都是校正好的，再校正丢�次有点多佄1�7
    ...
    // Camera pose.
    cv::Mat mTcw;///< 相机姿��1�7 世界坐标系到相机坐标坐标系的变换矩阵
    ...
    // Scale pyramid info.
    int mnScaleLevels;//图像提金字塔的层敄1�7
    float mfScaleFactor;//图像提金字塔的尺度因孄1�7
